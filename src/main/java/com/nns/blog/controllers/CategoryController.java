...
public class CategoryController {
    ...
    public ResponseEntity<Object> createCategory(@Valid @RequestBody CategoryDto catDto) {
        ...
        return ResponseHandler.generateResp(category, "Creating Category", HttpStatus.CREATED, Code.SUCCESS.getCode());
    }
    ...
    public ResponseEntity<Object> updateCategory(@Valid @RequestBody CategoryDto catDto,
        ...
        return ResponseHandler.generateResp(categoryDto, "Update Category", HttpStatus.OK, Code.SUCCESS.getCode());
    }
    ...
    public ResponseEntity<?> deleteCategory(@PathVariable Long catId) {
        ...
        return ResponseHandler.generateResp("Category is Deleted", HttpStatus.OK, Code.SUCCESS.getCode());
    }
    ...
    public ResponseEntity<Object> getCategory(@PathVariable Long catId) {
        ...
        return ResponseHandler.generateResp(category, "Category", HttpStatus.OK, Code.SUCCESS.getCode());
    }
    ...
    public ResponseEntity<?> getAllCategory() {
        ...
        return ResponseHandler.generateResp(categoryDtos, "All Categories", HttpStatus.OK, Code.SUCCESS.getCode());
    }
}
